...
!function (a, b) {
    ...
    !function (a, b) {
        ...
        a.fn.validateOnBlur = function (b, c) {
            ...
            var i = this, j = i.closest("form"), k = a.formUtils.validateInput(i, c, d, j, f);
        ...
        a.formUtils = a.extend(a.formUtils || {}, {
            ...
            validateInput: function (b, c, d, e, f) {
                ...
                var h = "true" === b.valAttr("optional"), i = !g && h, j = b.attr(d.validationRuleAttribute), k = !0,
                    l = "", m = {isValid: !0, shouldChangeDisplay: !0, errorMsg: ""};
        ...
        a.formUtils.addValidator({
            ...
            name: "number", validatorFunction: function (a, b, c) {
                if ("" !== a) {
                    var d, e, f = b.valAttr("allowing") || "", g = b.valAttr("decimal-separator") || c.decimalSeparator,
                        h = !1, i = b.valAttr("step") || "", j = !1, k = b.attr("data-sanitize") || "",
